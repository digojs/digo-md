...
function renderInline(source, options) {
    var doc = parseInline(source, options);
    var renderer = options.renderer || new Renderer(options);
    return renderer.render(doc);
}
...
var Renderer = (function () {
    ...
    Renderer.prototype.html = function (node) {
    };
    return Renderer;
}());
exports.Renderer = Renderer;
function parseBlock(source, options, parent) {
    quickParse(source, [
        {
            match: /^\n+/,
            parse: function () {
        ...
        {
            match: /^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\s*\1 *(?:\n+|$)/,
            parse: function (all, quote, lang, value) {
                parent.children.push({
                    type: "pre",
                    content: value || "",
                    data: lang,
        ...
        {
            match: /^ *(#{1,6}) *([^\n]+?) *#* *(?:\n+|$)/,
            parse: function (all, depth, value) {
                parent.children.push({
                    type: "pre",
                    content: value || "",
                    data: depth,
...
function quickParse(source, parsers) {
}
/**
